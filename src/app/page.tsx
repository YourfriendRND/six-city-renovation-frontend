...
import { getPlaces, getActiveCity } from '@/shared/store/slices/places/places.selectors';
import { fetchPlaces } from '@/shared/store/async-actions';
...
export default function Home() {
  ...
  useEffect(() => {
    dispatch(fetchPlaces(activeCity))
  }, [activeCity, dispatch]);
